package org.apache.karaf.ds.example.component.managedservice.consumer;
...
@Component(enabled = true, immediate = true, name = ManagedExampleServiceConsumerComponent.COMPONENT_NAME)
public class ManagedExampleServiceConsumerComponent {

	public static final String COMPONENT_NAME = "org.apache.karaf.ds.example.component.managedservice.consumer";

	private static final Logger LOGGER = LoggerFactory
			.getLogger(ManagedExampleServiceConsumerComponent.class);
	...
	@Reference(target = "(component.name=org.apache.karaf.ds.example.managed.provider)")
