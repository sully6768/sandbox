...
public class CamelContextServcieProvider extends OsgiDefaultCamelContext implements
	...
	public CamelContextServcieProvider() {
		...
		super(FrameworkUtil.getBundle(CamelContextServcieProvider.class).getBundleContext());
	}

	@Activate
	public void activate(Map<?, ?> properties) {
		LOG.info("Activating the CamelContextServcieProvider");
		this.setName("ds.camel.context");
		try {
			rwl.readLock().lock();
