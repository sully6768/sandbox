...
public class SimpleJmsDurableTopicTest extends CamelTestSupport {

    @Produce(uri = "direct:start")
    protected ProducerTemplate template;
    
    public SimpleJmsDurableTopicTest() {
    	enableJMX();
	}
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("sjms:topic:test.foo?subscriptionName=foo").to("mock:result");
                from("sjms:topic:test.foo?subscriptionName=bar").to("mock:result2");
            }
        };
    }
}
